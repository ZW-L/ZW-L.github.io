...
&emsp;&emsp;基础类标签共 19 个，其中 `<basefont>` 不再被 HTML5 支持。
...
标签|描述|属性|版本|兼容性
-|-|-|-|-
`<basefont>`|页面文本的默认字体、颜色、尺寸|-|<font color="red">HTML5废弃</font>|-
...
`<hgroup>`|对 `<h1>` ~ `<h6>` 进行分组|-|<font color="orange">HTML5</font>|IE8 或更早不支持
